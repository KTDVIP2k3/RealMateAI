...
public class InvestmentFuturePlanController {
    ...
    @Operation(summary = "Investor: Gửi feedback property đã chọn -> Tạo phiên bản kế hoạch tương lai mới (chỉ trả về futureInvestmentPlanId — gọi GET /investment-plans/future/{futureInvestmentPlanId} riêng để lấy output đầy đủ)")
