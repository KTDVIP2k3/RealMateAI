    ...
    public ResponseEntity<ApiResponse> payMemberShipSubscriptions(Integer membershipPlanId) {
        try {
            ...
            Transaction transaction = Transaction.builder()
                    ...
                    .docnoId(membershipPlan != null ? membershipPlan.getMembershipPlanId() : null)
                    .totalAmount(price)
    ...
    public ResponseEntity<ApiResponse> renewMemberShipSubscriptions(Integer membershipSubscriptionId) {
        try {
            ...
            Transaction transaction = Transaction.builder()
                    ...
                    .transactionDate(LocalDateTime.now())
                    .docnoId(oldSubscription.getMembershipPlan() != null ? oldSubscription.getMembershipPlan().getMembershipPlanId() : null)
                    .totalAmount(price)
